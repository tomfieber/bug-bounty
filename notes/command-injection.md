...
> See also: [SSTI](ssti.md) | [File Inclusion](file-inclusion.md) | [RCE](rce.md)
...
# New line - %0a - Both commands executed
\n
...
# AND - %7c%7c - Second command (only if first succeeds)
&&

# OR - %26%26 - Second (only if first fails)
||
