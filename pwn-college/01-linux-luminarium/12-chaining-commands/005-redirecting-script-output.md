...
As far as the shell is concerned, your script is just another command. That means you can redirect its input and output just like you did for commands in the [Piping](https://pwn.college/linux-luminarium/piping) module! For example, you can write it to a file:
